...
- **Online Order Form**: `http://localhost:3000/order-online`
- **Kitchen KDS Screen**: `http://localhost:3000/admin/orders`
- **Cashier Settlement Hub**: `http://localhost:3000/admin/cashier`
- **Menu Management**: `http://localhost:3000/admin/menu-management`
- **Table & QR Management**: `http://localhost:3000/admin/tables`
